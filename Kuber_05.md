...
<img width="1129" height="566" alt="image" src="https://github.com/user-attachments/assets/d9ddfe3e-f1e0-4441-a239-ebcf7eca7c8a" />

#### PVC удалён, но PV остался, так как Reclaim Policy = Retain.
#### PV переходит в статус Released — он больше не привязан к PVC, но данные сохранены.
<img width="674" height="162" alt="image" src="https://github.com/user-attachments/assets/7d549cc9-a690-4e65-a42a-e356b367ce67" />
----
<img width="677" height="151" alt="image" src="https://github.com/user-attachments/assets/16a3a07c-52b0-40ab-8048-24a1be7c9243" />

PV нельзя сразу использовать с новым PVC, пока администратор вручную не очистит или не пересоздаст его.
