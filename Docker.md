...
## Задача 2.
**root@Uglycomp:/DOCKER_TEST# docker run --name zhelanov-custom-nginx-t2 -d -p 8080:80 zzugly/custom-nginx:1.0.0**  
...
**root@Uglycomp:/DOCKER_TEST# docker ps -a**  
...
**root@Uglycomp:/DOCKER_TEST# curl http://127.0.0.1:8080**  
Hey, Netology  
I will be DevOps Engineer!  
**root@Uglycomp:/DOCKER_TEST# docker stop zhelanov-custom-nginx-t2**  
...
**root@Uglycomp:/DOCKER_TEST# docker rename zhelanov-custom-nginx-t2 custom-nginx-t2**  
**root@Uglycomp:/DOCKER_TEST# docker ps -a**  
CONTAINER ID   IMAGE                       COMMAND                  CREATED         STATUS                      PORTS     NAMES  
113a1b8e2ed9   zzugly/custom-nginx:1.0.0   "/docker-entrypoint.…"   2 minutes ago   Exited (0) 30 seconds ago             custom-nginx-t2  
**root@Uglycomp:/DOCKER_TEST# docker start custom-nginx-t2**  
custom-nginx-t2  
**root@Uglycomp:/DOCKER_TEST# docker ps -a**  
CONTAINER ID   IMAGE                       COMMAND                  CREATED         STATUS         PORTS                                     NAMES  
...
**root@Uglycomp:/DOCKER_TEST# date +"%d-%m-%Y %T.%N %Z" ; sleep 0.150 ; docker ps ; ss -tlpn | grep 127.0.0.1:8080  ; docker logs custom-nginx-t2 -n1 ; docker exec -it custom-nginx-t2 base64 /usr/share/nginx/html/index.html**  
